...
public class CircuitBreakerScreen extends AbstractContainerScreen<CircuitManagerMenu> {
    ...
    public CircuitBreakerScreen(CircuitManagerMenu menu, Inventory inventory, Component title) {
    ...
    protected void renderBg(GuiGraphics graphics, float partialTick, int mouseX, int mouseY) {
        ...
        if ((this.menu).getEnergy() > 0) {
            int v = (int)Math.ceil((14.0F * (this.menu).getEnergy()));
        ...
        graphics.blit(IconButton.ICON_TEXTURES, this.leftPos + 66, this.topPos + 46, 0.0F, 10.0F,
                10, 10, 64, 64);
        if (ScreenHelper.isMouseWithinBounds(mouseX, mouseY, this.leftPos + 26, this.topPos + 25, 14, 14)) {
